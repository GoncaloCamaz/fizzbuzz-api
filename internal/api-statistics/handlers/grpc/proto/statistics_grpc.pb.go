...
type StatisticsServiceClient interface {
	CreateStatistic(ctx context.Context, in *StatisticRequest, opts ...grpc.CallOption) (*StatisticResponse, error)
}
...
func (c *statisticsServiceClient) CreateStatistic(ctx context.Context, in *StatisticRequest, opts ...grpc.CallOption) (*StatisticResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StatisticResponse)
	err := c.cc.Invoke(ctx, StatisticsService_CreateStatistic_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StatisticsServiceServer interface {
	CreateStatistic(context.Context, *StatisticRequest) (*StatisticResponse, error)
}
...
func (UnimplementedStatisticsServiceServer) CreateStatistic(context.Context, *StatisticRequest) (*StatisticResponse, error) {
...
func _StatisticsService_CreateStatistic_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StatisticsServiceServer).CreateStatistic(ctx, req.(*StatisticRequest))
	}
